...
The project files generated will have starter content as outlined in the Epicodus JavaScript course. The template will give relevant namespaces and paths for your project (i.e. pandemic will be replaced everywhere with the name you give to your project - YourProjectName).
...
```
dotnet new --install [ /Users/Your/Path/Here ]/pandemic
```
For example: When cloned to the Epicodus computer Desktop, the path would be /Users/Guest/Desktop/pandemic.  

The above command would then be:
```
dotnet new --install /Users/Guest/Desktop/pandemic
```
...
```
dotnet new pandemic -n [ YourProjectName ]
```
For example: If your project is called Banana the command would be:
```
dotnet new pandemic -n Banana
```
